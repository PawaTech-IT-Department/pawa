document.addEventListener("DOMContentLoaded", function () {
  ...
  const emailLink = document.querySelector('a[href="mailto:support@pawa.com"]');
  if (emailLink) {
    emailLink.addEventListener("click", function (event) {
      event.preventDefault();
      window.location.href = "mailto:support@pawa.com";
    });
  }

  const phoneLink = document.querySelector('a[href="tel:+254-123-4567"]'); //I am not sure if the contact number is correct, that's why it got a comment here
  if (phoneLink) {
    phoneLink.addEventListener("click", function (event) {
      event.preventDefault();
      window.location.href = "tel:+254-123-4567";
    });
  }
      ...
      icon.addEventListener("click", function (event) {
        ...
        switch (socialNetwork) {
          ...
          case "Whatsapp":
            ...
            destination = "https://wa.me/2541234567";
            break;
        }
  ...
  if (callNowButton) {
    ...
    callNowAnchor.setAttribute("href", "tel:+254-123-4567");
  }
