// Get references to elements
        ...
        const signupOptionsContainer = document.getElementById('signupOptionsContainer'); // Container for initial options
        const manualSignupFormContainer = document.getElementById('manualSignupFormContainer'); // Container for manual form
